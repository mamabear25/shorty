        ...
        <div className="md:flex flex-col justify-center items-center mt-8">
          <div className="mb-10 md:p-0 p-10">
            ...
            <div className="flex flex-wrap items-center">
              <input
                className="h-10 md:w-[300px] w-[400px] border border-gray-500 rounded-lg pl-4 mr-4 mb-2 md:mb-0"
                type="text"
                value={url}
              ...
              />
              <input
                className="h-10 md:w-[200px] w-[200px] border border-gray-500 pl-4 rounded-l-lg text-sm"
                type="text"
              ...
              />
              <button
                className="font-bold bg-orange-600 text-gray-50 px-4 py-2 rounded-r hover:bg-orange-700"

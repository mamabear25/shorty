...
//   //               viewBox="0 0 24 24"
//   //               fill="currentColor"
//   //               className="w-6 h-6 ml-2 transform rotate-180"
//   //             >
//   //               <path
//   //                 fillRule="evenodd"
...
//   //           </button>
//   //         </div>
//   //         <img src={Link} alt="link" className="md:w-[200px] w-[100px] mx-auto mt-4" />
//   //       </div>
//   //     );
//   //   }
    ...
    <div>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {userHistory.map((item, index) => (
                      <tr key={index}>
                        <td className="px-6 py-4 whitespace-nowrap">{item.shortUrl}</td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          {item.originalUrl ? `${item.originalUrl.slice(0, 50)}...` : ''}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <ShowAnalytics analytics={item.analytics} />
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <button
                            className="text-xs text-white bg-blue-500 hover:bg-blue-700 font-bold py-1 px-2 rounded"
                            onClick={() => generateQRCode(item.shortUrl)}
                          >
                            Generate QR Code
                          </button>
      ...
      {selectedItem && qrCode && (
        <div className="flex flex-col items-center mt-4">
          ...
          <button
            className="text-xs text-white bg-blue-500 hover:bg-blue-700 font-bold py-1 px-2 rounded mt-2"
